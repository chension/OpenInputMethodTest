...
public class CandidatesContainer extends RelativeLayout implements View.OnTouchListener, ArrowUpdater, Animation.AnimationListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        measuredHeight += d.getHeight()*0.125f;
