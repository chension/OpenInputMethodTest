...
import static com.chen.openinputmethodtest.service.IMEService.ImeState.STATE_APP_COMPLETION;
import static com.chen.openinputmethodtest.service.IMEService.ImeState.STATE_COMPOSING;
import static com.chen.openinputmethodtest.service.IMEService.ImeState.STATE_PREDICT;
...
public class DecodingInfo {
    ...
    public boolean candidatesFromApp() {
        return STATE_APP_COMPLETION == mImeState;
    }
    ...
    public void choosePredictChoice(int choiceId) {
        if (STATE_PREDICT != mImeState || choiceId < 0
     ...
     * @param completions
     */
    public void prepareAppCompletions(CompletionInfo completions[]) {
        resetCandidates();
