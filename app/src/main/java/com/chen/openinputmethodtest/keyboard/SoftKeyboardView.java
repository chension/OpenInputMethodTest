...
public class SoftKeyboardView extends View {
	...
	public boolean moveToNextKey(int direction, CandidatesContainer candidatesContainer, SkbContainer skbContainer, DecodingInfo decInfo) {
		...
		case KeyEvent.KEYCODE_DPAD_LEFT:
			// 快速查询按键.
			SoftKey.SaveSoftKey saveLSoftKey = selectKey.getNextLeftKey();
		...
		case KeyEvent.KEYCODE_DPAD_RIGHT:
			// 快速查询按键.
			SoftKey.SaveSoftKey saveRSoftKey = selectKey.getNextRightKey();
		...
		case KeyEvent.KEYCODE_DPAD_DOWN:
			// 快速查询按键.
			SoftKey.SaveSoftKey saveBSoftKey = selectKey.getNextBottomKey();
		...
		case KeyEvent.KEYCODE_DPAD_UP:
			// 快速查询按键.
			SoftKey.SaveSoftKey saveTSoftKey = selectKey.getNextTopKey();
			...
			if (softKey != null) {
				...
				// 保存下个方向的按键.
				if (softKey != null) {
					OPENLOG.D(TAG,"KEYCODE_DPAD_UP55"+currentRow);
